...
-- Insert sample daily challenges (usando valores válidos das constraints)
...
('Primeira Vitória', 'Jogue sua primeira partida hoje', 'daily', 'games_played', 1, 50, CURRENT_DATE, CURRENT_DATE + INTERVAL '1 day'),
('Explorador Químico', 'Mantenha uma sequência de acertos', 'daily', 'streak', 3, 30, CURRENT_DATE, CURRENT_DATE + INTERVAL '1 day'),
('Mestre da Precisão', 'Alcance alta precisão em suas jogadas', 'daily', 'accuracy', 80, 100, CURRENT_DATE, CURRENT_DATE + INTERVAL '1 day');
