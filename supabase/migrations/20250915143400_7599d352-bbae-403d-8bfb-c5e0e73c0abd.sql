-- Add more common element cards for better variety
...
('Ferro', 'Fe', 26, 55.845, 7.87, 1538, 50, 0, 'Cavaleiro Ferro, o Indestrutível', 'metal', 'rare', 'Magnetismo: Atrai projéteis inimigos redirecionando para si', 'Lendário guerreiro do núcleo terrestre'),
...
-- Epic noble gases
('Hélio', 'He', 2, 4.003, 0.18, -272, 5, 0, 'Príncipe Hélio, o Etéreo', 'noble_gas', 'epic', 'Levitação: Imune a ataques terrestres, voa permanentemente', 'Nobre espírito dos céus e estrelas'),
...
-- Legendary heavy elements
('Ouro', 'Au', 79, 196.967, 19.30, 1064, 15, 0, 'Imperador Ouro, o Incorruptível', 'metal', 'legendary', 'Pureza Absoluta: Imune a todos os efeitos negativos', 'Soberano eterno dos metais preciosos'),
...
-- Update existing cards to have better descriptions
